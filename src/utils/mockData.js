...
export async function triggerAutomationEvent(event, data = {}, attachment) {
  try {
    ...
    const res = await fetch(
      `https://rthxlprgtfuhntpcdhsh.supabase.co/functions/v1/trigger-automation?event=${encodeURIComponent(event)}`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJ0aHhscHJndGZ1aG50cGNkaHNoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3ODM0OTM1NSwiZXhwIjoyMDkzOTI1MzU1fQ.4CXw_d9a0XZgtRUnpiyua2OIiFhSxxeaMsP2h10Nxkk',
          'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJ0aHhscHJndGZ1aG50cGNkaHNoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzgzNDkzNTUsImV4cCI6MjA5MzkyNTM1NX0.men8PNFnr8Na3H53pjX4dzg9FGQH8dCNefVKti5M-UM',
        },
